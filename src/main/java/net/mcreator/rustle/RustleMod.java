...
@Mod("rustle")
public class RustleMod {
	public static final Logger LOGGER = LogManager.getLogger(RustleMod.class);
	...
	public RustleMod() {
		...
		RustleModItems.REGISTRY.register(bus);
