...
import net.mcreator.rustle.procedures.ShearSheepProcedure;
import net.mcreator.rustle.init.RustleModEntities;

import java.util.List;

@Mod.EventBusSubscriber
public class SheepEntity extends Animal implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(RustleModEntities.SHEEP.get(), 20, 4, 4));
	}

	public SheepEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RustleModEntities.SHEEP.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ShearSheepProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SheepEntity retval = RustleModEntities.SHEEP.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(RustleModEntities.SHEEP.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
