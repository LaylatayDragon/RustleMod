package com.laylataydragon.rustlemod.client.renderer.Layers;
...
public class CowLayer extends GeoLayerRenderer {
	    // A resource location for the texture of the layer. This will be applied onto pre-existing cubes on the model
	    private static final ResourceLocation LAYER = new ResourceLocation("rustle", "textures/entities/cow_albino.png");
	    ...
	    private static final ResourceLocation MODEL = new ResourceLocation(Rustle.MODID, "geo/cow.geo.json");

		public CowLayer(IGeoRenderer<?> entityRendererIn) {
